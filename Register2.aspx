<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register2.aspx.cs" Inherits="Jaguar.Register2" %>
...
<body>
    <form id="Form1" runat="server" class="container">
        <h4 style="padding-left: 170px; margin-top: 10px">Edit User</h4>
        <div class="card-background">
          ...
          <asp:ListItem>LAB-ADMIN</asp:ListItem>
            ...
            <div style="text-align: center">
                ...
                <asp:LinkButton runat="server" OnClick="Button1_Click" class="btn btn-outline-success btn-rounded" Text="<i class='fa fa-check'></i>Update"></asp:LinkButton>
